...
class ReportItemApi
{
    ...
    public function reportItemWithHttpInfo($json)
    {
        ...
        $request = $this->reportItemRequest($json);
     ...
     */
    public function reportItemAsync($json)
    {
        return $this->reportItemAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportItemAsyncWithHttpInfo
     *
     * Use report_item to let us know when another user reports that this item may violate your company’s policies.
     *
     * @param  \ai\thirdwatch\Model\ReportItem $json Pass report item info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportItemAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->reportItemRequest($json);
    ...
    /**
     * Create request for operation 'reportItem'
     *
     * @param  \ai\thirdwatch\Model\ReportItem $json Pass report item info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item id. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function reportItemRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling reportItem'
            );
        }
