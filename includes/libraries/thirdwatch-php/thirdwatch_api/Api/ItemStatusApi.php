...
class ItemStatusApi
{
    ...
    public function itemStatusWithHttpInfo($json)
    {
        ...
        $request = $this->itemStatusRequest($json);
     ...
     */
    public function itemStatusAsync($json)
    {
        return $this->itemStatusAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation itemStatusAsyncWithHttpInfo
     *
     * Use item_status to update the status of item that you’ve already pass to Thirdwatch.
     *
     * @param  \ai\thirdwatch\Model\ItemStatus $json Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemStatusAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->itemStatusRequest($json);
    ...
    /**
     * Create request for operation 'itemStatus'
     *
     * @param  \ai\thirdwatch\Model\ItemStatus $json Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function itemStatusRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling itemStatus'
            );
        }
