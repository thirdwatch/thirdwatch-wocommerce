...
class AddPromotionApi
{
    ...
    public function addPromotionWithHttpInfo($json)
    {
        ...
        $request = $this->addPromotionRequest($json);
     ...
     */
    public function addPromotionAsync($json)
    {
        return $this->addPromotionAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addPromotionAsyncWithHttpInfo
     *
     * Use add_promotion to record when a user adds one or more promotions to their account.
     *
     * @param  \ai\thirdwatch\Model\AddPromotion $json Pass added promotion info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain promotion info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addPromotionAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->addPromotionRequest($json);
    ...
    /**
     * Create request for operation 'addPromotion'
     *
     * @param  \ai\thirdwatch\Model\AddPromotion $json Pass added promotion info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain promotion info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addPromotionRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling addPromotion'
            );
        }
