...
class CustomEventApi
{
    ...
    public function customEventWithHttpInfo($json)
    {
        ...
        $request = $this->customEventRequest($json);
     ...
     */
    public function customEventAsync($json)
    {
        return $this->customEventAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customEventAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->customEventRequest($json);
     ...
     */
    protected function customEventRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling customEvent'
            );
        }
