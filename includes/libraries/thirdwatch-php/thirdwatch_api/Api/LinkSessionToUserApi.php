...
class LinkSessionToUserApi
{
    ...
    public function linkSessionToUserWithHttpInfo($json)
    {
        ...
        $request = $this->linkSessionToUserRequest($json);
    ...
    /**
     * Operation linkSessionToUserAsync
     *
     * Use link_session_to_user to associate specific session to a user. Generally used only in anonymous checkout workflows.
     *
     * @param  \ai\thirdwatch\Model\LinkSessionToUser $json Pass session and user to thirdwatch for link. Only &#x60;_userID&#x60; is required field. But this should contain session and user info. (required)
     ...
     */
    public function linkSessionToUserAsync($json)
    {
        return $this->linkSessionToUserAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation linkSessionToUserAsyncWithHttpInfo
     *
     * Use link_session_to_user to associate specific session to a user. Generally used only in anonymous checkout workflows.
     *
     * @param  \ai\thirdwatch\Model\LinkSessionToUser $json Pass session and user to thirdwatch for link. Only &#x60;_userID&#x60; is required field. But this should contain session and user info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function linkSessionToUserAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->linkSessionToUserRequest($json);
    ...
    /**
     * Create request for operation 'linkSessionToUser'
     *
     * @param  \ai\thirdwatch\Model\LinkSessionToUser $json Pass session and user to thirdwatch for link. Only &#x60;_userID&#x60; is required field. But this should contain session and user info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function linkSessionToUserRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling linkSessionToUser'
            );
        }
