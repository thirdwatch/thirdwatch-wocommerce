...
class LoginApi
{
    ...
    public function loginWithHttpInfo($json)
    {
        ...
        $request = $this->loginRequest($json);
     ...
     */
    public function loginAsync($json)
    {
        return $this->loginAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->loginRequest($json);
     ...
     */
    protected function loginRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling login'
            );
        }
