...
class TransactionApi
{
    ...
    public function transactionWithHttpInfo($json)
    {
        ...
        $request = $this->transactionRequest($json);
     ...
     */
    public function transactionAsync($json)
    {
        return $this->transactionAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transactionAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->transactionRequest($json);
     ...
     */
    protected function transactionRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling transaction'
            );
        }
