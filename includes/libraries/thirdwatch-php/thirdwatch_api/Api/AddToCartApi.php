...
class AddToCartApi
{
    ...
    public function addToCartWithHttpInfo($json)
    {
        ...
        $request = $this->addToCartRequest($json);
     ...
     */
    public function addToCartAsync($json)
    {
        return $this->addToCartAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addToCartAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->addToCartRequest($json);
     ...
     */
    protected function addToCartRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling addToCart'
            );
        }
