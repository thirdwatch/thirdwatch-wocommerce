...
class UpdateOrderApi
{
    ...
    public function updateOrderWithHttpInfo($json)
    {
        ...
        $request = $this->updateOrderRequest($json);
     ...
     */
    public function updateOrderAsync($json)
    {
        return $this->updateOrderAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrderAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->updateOrderRequest($json);
     ...
     */
    protected function updateOrderRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling updateOrder'
            );
        }
