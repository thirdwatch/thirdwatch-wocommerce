...
class ChargebackApi
{
    ...
    public function chargebackWithHttpInfo($json)
    {
        ...
        $request = $this->chargebackRequest($json);
     ...
     */
    public function chargebackAsync($json)
    {
        return $this->chargebackAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation chargebackAsyncWithHttpInfo
     *
     * Use chargeback to capture a chargeback reported on a transaction. This event can be called multiple times to record changes to the chargeback state.
     *
     * @param  \ai\thirdwatch\Model\Chargeback $json Pass chargeback to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain chargeback info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chargebackAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->chargebackRequest($json);
    ...
    /**
     * Create request for operation 'chargeback'
     *
     * @param  \ai\thirdwatch\Model\Chargeback $json Pass chargeback to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain chargeback info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function chargebackRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling chargeback'
            );
        }
