...
class UpdateAccountApi
{
    ...
    public function updateAccountWithHttpInfo($json)
    {
        ...
        $request = $this->updateAccountRequest($json);
     ...
     */
    public function updateAccountAsync($json)
    {
        return $this->updateAccountAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAccountAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->updateAccountRequest($json);
     ...
     */
    protected function updateAccountRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling updateAccount'
            );
        }
