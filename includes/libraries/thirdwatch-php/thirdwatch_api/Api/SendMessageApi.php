...
class SendMessageApi
{
    ...
    public function sendMessageWithHttpInfo($json)
    {
        ...
        $request = $this->sendMessageRequest($json);
     ...
     */
    public function sendMessageAsync($json)
    {
        return $this->sendMessageAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMessageAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->sendMessageRequest($json);
     ...
     */
    protected function sendMessageRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling sendMessage'
            );
        }
