...
class RemoveFromCartApi
{
    ...
    public function removeFromCartWithHttpInfo($json)
    {
        ...
        $request = $this->removeFromCartRequest($json);
     ...
     */
    public function removeFromCartAsync($json)
    {
        return $this->removeFromCartAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeFromCartAsyncWithHttpInfo
     *
     * Use remove_from_cart when a user removes an item from their shopping cart or list.
     *
     * @param  \ai\thirdwatch\Model\RemoveFromCart $json Pass removed item info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeFromCartAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->removeFromCartRequest($json);
    ...
    /**
     * Create request for operation 'removeFromCart'
     *
     * @param  \ai\thirdwatch\Model\RemoveFromCart $json Pass removed item info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function removeFromCartRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling removeFromCart'
            );
        }
