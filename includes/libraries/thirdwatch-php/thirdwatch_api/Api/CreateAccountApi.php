...
class CreateAccountApi
{
    ...
    public function createAccountWithHttpInfo($json)
    {
        ...
        $request = $this->createAccountRequest($json);
     ...
     */
    public function createAccountAsync($json)
    {
        return $this->createAccountAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAccountAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->createAccountRequest($json);
     ...
     */
    protected function createAccountRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling createAccount'
            );
        }
