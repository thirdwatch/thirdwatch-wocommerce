...
class TagAPIApi
{
    ...
    public function tagUserWithHttpInfo($json)
    {
        ...
        $request = $this->tagUserRequest($json);
     ...
     */
    public function tagUserAsync($json)
    {
        return $this->tagUserAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tagUserAsyncWithHttpInfo
     *
     * The Tag API enables you to tell Thirdwatch which of your users are bad and which are good.
     *
     * @param  \ai\thirdwatch\Model\Tag $json Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagUserAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->tagUserRequest($json);
    ...
    /**
     * Create request for operation 'tagUser'
     *
     * @param  \ai\thirdwatch\Model\Tag $json Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function tagUserRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling tagUser'
            );
        }
