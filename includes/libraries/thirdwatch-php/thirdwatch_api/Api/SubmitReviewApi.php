...
class SubmitReviewApi
{
    ...
    public function submitReviewWithHttpInfo($json)
    {
        ...
        $request = $this->submitReviewRequest($json);
     ...
     */
    public function submitReviewAsync($json)
    {
        return $this->submitReviewAsyncWithHttpInfo($json)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitReviewAsyncWithHttpInfo
     *
     * Use submit_review when a user-submitted review of a product or seller.
     *
     * @param  \ai\thirdwatch\Model\SubmitReview $json Pass review to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain review info. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitReviewAsyncWithHttpInfo($json)
    {
        $returnType = '\ai\thirdwatch\Model\EventResponse';
        $request = $this->submitReviewRequest($json);
    ...
    /**
     * Create request for operation 'submitReview'
     *
     * @param  \ai\thirdwatch\Model\SubmitReview $json Pass review to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain review info. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function submitReviewRequest($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $json when calling submitReview'
            );
        }
